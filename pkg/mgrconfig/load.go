...
func completeBinaries(cfg *Config) error {
	...
	cfg.SyzFuzzerBin = targetBin("syz-fuzzer", cfg.TargetVMOS, cfg.TargetVMArch)
	cfg.SyzExecprogBin = targetBin("syz-execprog", cfg.TargetVMOS, cfg.TargetVMArch)
	cfg.SyzExecutorBin = targetBin("syz-executor", cfg.TargetOS, cfg.TargetArch)
